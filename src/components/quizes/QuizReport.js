...
export default function QuizReport() {
  ...
  return (
    <div>
      <Navbar />
      <Box sx={{ padding: "40px", maxWidth: "900px", margin: "auto", textAlign: "center" }}>
        <Paper elevation={4} sx={{ padding: "30px", borderRadius: "16px", backgroundColor: "#f9f9f9" }}>
          {/* Title Section */}
          <Typography variant="h3" sx={{ fontWeight: "bold", marginBottom: "20px", color: "#3f51b5" }}>
            Quiz Report
          </Typography>
          ...
          >
            ...
            >
              ...
              <Typography
                variant="h4"
                sx={{ marginTop: "10px", fontWeight: "bold", color: getColor() }}
              >
          ...
          <Grid container spacing={2} justifyContent="center">
            <Grid item xs={12} sm={6}>
              <Paper sx={{ padding: "20px", backgroundColor: "#e3f2fd", borderRadius: "12px" }}>
