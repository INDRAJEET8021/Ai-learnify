...
def gen_roadmap(topic):
    response = model.generate_content(f"""Generate a full course roadmap for the {topic}. Provide the output in JSON format, including the course title, a list of modules, and the headings under each module. Generate as many heading as possible 
